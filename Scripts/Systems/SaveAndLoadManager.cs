...
public partial class SaveAndLoadManager : Node {
	...
	public void SaveUserSetting(SettingData runtimeSetting) { ResourceSaver.Save(runtimeSetting, _userSettingPath); }

	public SettingData GetDefaultSetting() { return _defaultSetting; }
}